...
Route::get('/telegram/login/{token}', [TelegramLoginController::class, 'login'])
    ->name('telegram.login');
...
Route::middleware(['auth', 'verified'])->prefix('admin')->group(function () {
    Route::get('landing', function () {
        $landingService = app(\App\Services\AuthLandingService::class);

        return redirect()->to($landingService->resolveFor(request()->user()));
    })->name('admin.landing');
    ...
    Route::post('departments/{department}/test-telegram', [DepartmentController::class, 'testTelegram'])
        ->name('admin.departments.test-telegram');
    ...
    Route::post('canned-responses/bulk-update', [CannedResponseController::class, 'bulkUpdate'])
        ->name('admin.canned-responses.bulk-update');
    Route::post('canned-responses/bulk-delete', [CannedResponseController::class, 'bulkDelete'])
        ->name('admin.canned-responses.bulk-delete');
    ...
    Route::resource('automation-rules', AutomationRuleController::class)
        ...
        ->middlewareFor('index', 'permission:automation-rules.view')
        ->middlewareFor(['create', 'store'], 'permission:automation-rules.create')
        ->middlewareFor(['edit', 'update'], 'permission:automation-rules.edit')
        ->middlewareFor('destroy', 'permission:automation-rules.delete');

    Route::resource('escalation-rules', EscalationRuleController::class)
        ->except('show')
        ->names('admin.escalation-rules')
        ->middlewareFor('index', 'permission:escalation-rules.view')
        ->middlewareFor(['create', 'store'], 'permission:escalation-rules.create')
        ->middlewareFor(['edit', 'update'], 'permission:escalation-rules.edit')
        ->middlewareFor('destroy', 'permission:escalation-rules.delete');
