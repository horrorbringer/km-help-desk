...
export default function RejectedTickets({ tickets }: Props) {
    ...
    const handleResubmit = (ticketId: number) => {
        router.post(
            route('admin.tickets.resubmit', { ticket: ticketId }),
            {},
            {
                onSuccess: () => {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-muted-foreground">
                            Tickets that were rejected during the approval
                            process
                        </p>
                    </div>
                        ...
                        {tickets.data.length === 0 ? (
                            <div className="py-12 text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    There are no tickets that have been
                                    rejected.
                                </p>
                            </div>
                        ) : (
                            <div className="space-y-4">
                                {tickets.data.map((ticket) => (
                                    <div
                                        key={ticket.id}
                                        className="rounded-lg border border-red-100 bg-card p-4 transition-all duration-200 hover:border-primary/50 hover:shadow-sm"
                                    >
