...
import { IconBookmarkFilled, IconX } from '@tabler/icons-react';
...
export function AdvancedSearch({
    ...
    const loadSavedSearches = async () => {
        try {
            const response = await fetch(
                route('admin.saved-searches.index', { type: 'tickets' }),
            );
            if (
                response.headers
                    .get('content-type')
    ...
    const applySavedSearch = async (search: SavedSearch) => {
        try {
            const response = await fetch(
                route('admin.saved-searches.apply', search.id),
            );
            if (
                !response.headers
                    .get('content-type')
                        ...
                        <div className="space-y-4 p-4">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={
                                            (filters.order_by as string) ??
                                            'created_at'
                                        }
                                        onValueChange={(value) =>
                                            handleFilter('order_by', value)
                                        }
                                    >
                                        <SelectTrigger>
                                            <SelectValue />
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="ticket_number">
                                                Ticket Number
                                            </SelectItem>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={
                                            (filters.order_dir as string) ??
                                            'desc'
                                        }
                                        onValueChange={(value) =>
                                            handleFilter('order_dir', value)
                                        }
                                    >
                                        <SelectTrigger>
                                            <SelectValue />
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex max-h-32 flex-wrap gap-2 overflow-y-auto rounded border p-2">
                                        {options.priorities.map((priority) => {
                                            const priorityArray = Array.isArray(
                                                filters.priority,
                                            )
                                                ? filters.priority
                                                : filters.priority
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={
                                            (filters.team as string) ?? '__all'
                                        }
                                        onValueChange={(value) =>
                                            handleFilter('team', value)
                                        }
                                    >
                                        <SelectTrigger>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={
                                            (filters.agent as string) ?? '__all'
                                        }
                                        onValueChange={(value) =>
                                            handleFilter('agent', value)
                                        }
                                    >
                                        <SelectTrigger>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={
                                            (filters.project as string) ??
                                            '__all'
                                        }
                                        onValueChange={(value) =>
                                            handleFilter('project', value)
                                        }
                                    >
                                        <SelectTrigger>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={
                                            (filters.sla_breached as string) ??
                                            '__all'
                                        }
                                        onValueChange={(value) =>
                                            handleFilter('sla_breached', value)
                                        }
                                    >
                                        <SelectTrigger>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        value={
                                            (filters.approval_status as string) ??
                                            '__all'
                                        }
                                        onValueChange={(value) =>
                                            handleFilter(
